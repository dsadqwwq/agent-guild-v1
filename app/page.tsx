...
import { BookOpen, Rocket, Flame, Bot, ChartPie, ExternalLink, Cpu, Link2, Copy, Check } from 'lucide-react'
...
const CONTRACT = 'F8UKoSDzT4uSiVcv5SzLFhm32XejFU9LVe8tYukFpump'

const IconX = (props:any) => (
  <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
    <path fill="currentColor" d="M18.244 2H21l-6.66 7.639L22 22h-6.884l-4.449-5.797L5.49 22H2.732l7.103-8.15L2 2h6.96l4.028 5.333L18.244 2Zm-2.395 17.83h1.792L8.33 4.072H6.404l9.445 15.758Z"/>
  </svg>
)
const IconTG = (props:any) => (
  <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
    <path fill="currentColor" d="M9.51 15.283 9.27 18.4c.347 0 .498-.15.678-.33l1.626-1.556 3.37 2.487c.617.342 1.056.163 1.225-.57l2.215-9.337c.202-.82-.297-1.14-.83-.94L5.98 11.375c-.8.31-.787.756-.135.96l3.373 1.05 7.818-4.93c.368-.24.703-.107.427.132l-6.953 6.696Z"/>
  </svg>
)
...
export default function Page() {
  ...
  const handleCopy = async () => {
    try { await navigator.clipboard.writeText(CONTRACT); setCopied(true); setTimeout(()=>setCopied(false),1500) } catch {}
  }
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,_rgba(168,85,247,.14),transparent)]">
      <nav className="sticky top-0 z-50 border-b border-white/10 backdrop-blur bg-black/40">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Image src="/assets/pixel-robot.svg" alt="Agent Guild" width={40} height={40} className="rounded-lg border border-white/10" />
            <div>
      ...
      <header className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 py-24 md:py-32 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <motion.p initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.05, duration: 0.6 }} className="mt-6 text-lg text-white/70 max-w-xl">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              {/* Icon buttons: larger, icon-as-button */}
              <a aria-label="X (Twitter)" href="https://x.com/agent_guild" target="_blank" rel="noreferrer" className="btn-icon">
                <IconX className="w-6 h-6" />
              </a>
              <a aria-label="Telegram" href="https://t.me/agentguild" target="_blank" rel="noreferrer" className="btn-icon">
                <IconTG className="w-6 h-6" />
              </a>
            </div>

            <div className="mt-6 p-3 rounded-xl border border-white/10 bg-white/5 max-w-xl">
              <div className="text-xs text-white/60 mb-1">Token Address (Solana)</div>
              <div className="flex items-center gap-2">
                <div className="mono text-sm text-white/90 break-all">{CONTRACT}</div>
                <button onClick={handleCopy} className="btn btn-secondary !px-3 !py-1.5">
      ...
      <section id="agent" className="max-w-6xl mx-auto px-4 -mt-8">
        <Card>
          ...
          <CardContent>
            <div className="rounded-2xl border border-white/10 p-5 bg-black/30">
              ...
              <button className="btn btn-secondary w-full opacity-60 mt-4" disabled>Deploy Agent</button>
            </div>
          </CardContent>
        </Card>
      </section>

      <section id="token" className="max-w-7xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold flex items-center gap-2"><ChartPie className="h-7 w-7" /> Tokenomics</h2>
            <p className="mt-4 text-white/70">Nominal supply: 1,000,000,000 $GUILD. Distribution emphasizes broad public access and a modest treasury for airdrops and team with vesting.</p>
      ...
      <section id="buy" className="max-w-7xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
          ...
          <div className="rounded-2xl overflow-hidden border border-white/10 shadow-xl bg-white/5">
            <iframe src="https://dexscreener.com/" title="DexScreener" className="w-full h-[460px] border-none" />
          </div>
        </div>
      </section>

      <section id="docs" className="max-w-7xl mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
          ...
          <div className="rounded-2xl overflow-hidden border border-white/10 shadow-xl bg-white/5">
            <iframe src="https://agentguild.gitbook.io/agent_guild_docs/~/changes/1/docs/overview" title="Agent Guild Docs" className="w-full h-[460px] border-none" />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 py-10 grid md:grid-cols-2 gap-6 items-center">
          <div className="text-white/60 text-sm flex items-center gap-2">
            ...
            <a href="https://pump.fun" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1">
              <img src="/assets/pumpfun-pill.svg" alt="Pump.fun" width="64" height="18" className="inline-block h-5 w-auto align-middle object-contain" />
            </a>
          </div>
